...
- Meng appel stukjes voor de vulling met abrikozenpuree (met daarin de custard) en de optionele ingredienten (gewelde en aangedroogde rozijnen, limoen/citroenrasp, e.d.).  
...
- kijk of je moet repareren (zie Appendix A)
- verwarm abrikozenjam een beetje (niet koken).  
- glazuur de taart met warme abrikozenjam (deppend aanbrengen, flink veel - niet 'schilderen').  
- vlak voor het serveren(!) kun je nog poedersuiker langs rand (leg eerst papieren cirkel op de taart zodat je alleen de rand bestuift).  

<div style="page-break-before: always;"></div>

## Appendix A: Repareren
...
## Appendix B: Abrikozenpuree maken van gedroogde abrikozen
