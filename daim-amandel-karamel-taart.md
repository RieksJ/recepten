...
Bereidingswijze combineert **parallel werken van onderdelen** met een logische **opbouw in de vorm**, fool-proof voor beginners.
...
- LET OP: De acceptabele marge is soms in procenten, maar soms (vooral bij kleine hoeveelheden) in grammen.
- Een kleine hoeveelheid van een krachtig middel (zoals bakpeoeder) moet je secuurder afwegen dan andere middelen.
  
### Ingrediënten Ganache (per taart)

# Daim Taart – Ganache met Variabel Chocoladegehalte (proportioneel)

Ganache aangepast aan chocoladegehalte zodat totaalgewicht en consistentie behouden blijven.  

| %Choc | Chocolade    | Slagroom     | Boter       | Effect / tips                     | Giet<br>Temp. |
| :---: | :-----:      | :-----:      | :-----:     | -------------                     | :-----: |
...
**Opmerking**: De rest van het recept (bodem, karamel, Daim) blijft gelijk; alleen ganache wordt aangepast aan chocoladegehalte.
...
## Bereidingswijze van onderdelen

### 1. Amandelbodem
1. Verwarm oven voor op 180°C.
2. Klop eiwit stijf met poedersuiker en bakpoeder tot glanzende pieken.
...
1. Verwarm suiker op middelhoog vuur tot goud/amberkleurig (150–160°C - Let op kleur en geur; goud/amberkleurige karamel ruikt nootachtig).  
...
1. Spreid de apart gehouden karamel dun uit op bakpapier.  
...
- Terwijl de **bodem bakt en afkoelt (duurt ongeveer 60 min.)**, kan je al **karamel, ganache en Daim** maken.  
- Zodra de bodem **volledig is afgekoeld**:
  1. Verdeel de karamel-amandelboterlaag over de bodem (behalve portie voor Daim).  
  2. Laat kort opstijven (10–15 min bij kamertemperatuur of half-opgesteven in koelkast).  
  3. Giet ganache erover en strijk glad.  
  4. Bestrooi met Daim-stukjes.

- Laat minimaal 3 uur opstijven, bij voorkeur een nacht.

### Tijdlijn en Planning voor Daim-taart (parallel werken)
...
- Suikerthermometer voor fool-proof karamel.  
- Pure chocolade geeft steviger en iets bitterder resultaat; slagroom iets verhogen voor smeuïgheid.
